class Guarda < ApplicationRecord
  ...
  validates :matricula, presence: { message: "Nº de matrícula não pode ser vazio" },  uniqueness: { message: "Nº de matrícula já existe" }
  validates :porte_arma, presence: { message: "Nº de porte de arma não pode ser vazio" }, uniqueness: { message: "Nº de porte de arma já existe" }
